<div class="reikomodal" id="editmodal">
    <div class="contenidomodal">
        ...
        <div class="cuerpomodal">
            <form action="{{route('cmodulos.update', '__ID__')}}" id="miFormulario" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                <img src="" alt="" id="imagen-preview" style="max-width: 100%; display: none;">
                <input type="file" name="imagenmodulo" id="moduloimagen" onchange="cargarImagen()">
