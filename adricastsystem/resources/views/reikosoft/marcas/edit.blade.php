<div class="reikomodal" id="editmodal">
    <div class="contenidomodal">
        ...
        <div class="cuerpomodal">
            <form action="{{route('marcas.update', '__ID__')}}" id="miFormulario" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <input type="text" name="descripcion" id="descripcion" placeholder="Descripcion de la Marca">
